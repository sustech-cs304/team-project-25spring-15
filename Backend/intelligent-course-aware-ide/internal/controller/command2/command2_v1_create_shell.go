...
func (c *ControllerV1) CreateShell(ctx context.Context, req *v1.CreateShellReq) (res *v1.CreateShellRes, err error) {
	...
	cwd := consts.PathForDocker + "user/" + strconv.FormatInt(operatorId, 10) + "/"
	...
	resp, err := http.Post(consts.TargetUrl+"/bash/create", "application/json", bytes.NewBuffer(jsonData))
	...
	var resResult v1.CreateShellRes
